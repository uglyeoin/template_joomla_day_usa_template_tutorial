...
<ul id="dj-megamenu<?php echo $module->id; ?>" class="dj-megamenu <?php echo 'dj-fa-'.$params->get('fa') . ' ' . 'dj-megamenu-'.$params->get('theme') . ' ' . $params->get('orientation') . 'Menu ' . $class_sfx; ?>"
